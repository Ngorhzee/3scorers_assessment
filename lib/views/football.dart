...
class FootballTimeline extends StatefulWidget {
  @override
  FootballTimelineState createState() => FootballTimelineState();
}

class FootballTimelineState extends State<FootballTimeline> {
    ...
    return Container(
      ...
      child: Theme(
        data: Theme.of(context).copyWith(
            // : const Color(0xFF117E69).withOpacity(0.2),
            ),
        child: SafeArea(
          child: Scaffold(
...
class _TimelineFootball extends StatelessWidget {
  const _TimelineFootball({super.key, required this.data});
...
class _MessageTimeline extends StatelessWidget {
  const _MessageTimeline({super.key, required this.message});
...
class _Score extends StatelessWidget {
  const _Score({super.key, required this.score, required this.team});
